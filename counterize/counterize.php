...
<form method="post" action="edit.php?page=counterize/counterize.php&amp;killmass=yes" name="tablesForm" id="tablesForm">
      ...
      ?>
        <tr <?php if($i%2) { print "class=\"alternate\""; } ?>>
                                ...
                                if ($entry->referer != "unknown")
          {
                                ...
                                <td scope="col" style="width:25%"><small><?php echo counterize_browser_string($entry->useragent , true, '<br>'); ?></small> </td>
	...
	<input type="button" name="CheckAll"   value="<?php _e("Check All",'counterize'); ?>"
		onClick="checkAll(document.tablesForm)" />
	<input type="button" name="UnCheckAll" value="<?php _e("Uncheck All",'counterize'); ?>"
		onClick="uncheckAll(document.tablesForm)" />
	<input type="SUBMIT" value="<?php _e("Delete selected Entries",'counterize'); ?>" />
...
function counterize_showStats($admin = false)
{
  ...
  <table width="100%" cellpadding="3" cellspacing="3">
        <tr>
                <td scope="col" style="width:15%" align="center">
                ...
                <td scope="col" style="width:20%" align="center">
  ...
  <div class="wrap">
        ...
        <?php counterize_most_visited_pages($amount2,$width); ?>
  </div>
  ...
  ?>
    <div class="wrap">
        ...
        <?php counterize_most_visited_IPs($amount2,$width); ?>
    </div>
  <?php
  }
  ?>
  <div class="wrap">
        ...
        <?php counterize_most_visited_referrers($amount2,$width); ?>
  </div>
  <div class="wrap">
  ...
  <div class="wrap">
        ...
        <?php counterize_most_used_browsers($amount2,$width); ?>
  </div>

  <div class="wrap">
        <h2><?php echo __("Most used operating systems ",'counterize') . "(" . $amount2 . ")";?></h2>
        <?php counterize_most_used_os($amount2,$width); ?>
  </div>

  <div class="wrap">
       <h2><?php echo __("Most searched keywords ",'counterize') . "(" . $amount2 . ")";?></h2>
       <?php counterize_most_searched_Keywords($amount2,$width); ?>
  </div>
 <?php
}
